...
export const ChangesetSpecAction: React.FunctionComponent<ChangesetSpecActionProps> = ({ spec, className }) => {
    ...
    return <ChangesetSpecActionUnknown className={className} />
}
...
export const ChangesetSpecActionReopen: React.FunctionComponent<{ className?: string }> = ({ className }) => (
    <div className={classNames(className, iconClassNames)}>
        <SourceBranchSyncIcon data-tooltip="This changeset will be reopened on the codehost" />
        <span>Reopen</span>
    </div>
)
...
export const ChangesetSpecActionUnknown: React.FunctionComponent<{ className?: string }> = ({ className }) => (
    <div className={classNames(className, iconClassNames)}>
        <BeakerQuestionIcon data-tooltip="The operation can't yet be displayed" />
        <span>Unknown</span>
    </div>
)
